...
const EN: Dict = {
  ...
  /* Quick chips · composer preset editor */
  'settings.chips':           'Quick chips',
  'chips.empty.relative':     'No relative chips. Add one below.',
  'chips.empty.absolute':     'No absolute chips. Add one below.',
  'chips.add':                'Add chip',
  'chips.add.title':          'New chip',
  'chips.edit.title':         'Edit chip',
  'chips.delete':             'Delete',
  'chips.reset':              'Reset chips to defaults',
  'chips.reset.confirm':      'Restore the built-in quick chips? Your custom chips will be removed.',
  'chips.label':              'Label',
  'chips.label.hint':         'e.g. Lunch',
  'chips.amount':             'Amount',
  'chips.unit':               'Unit',
  ...
  'chips.anchor':             'When',
  'chips.anchor.today':       'Today',
  'chips.anchor.tomorrow':    'Tomorrow',
  'chips.anchor.mon':         'Monday',
  'chips.anchor.tue':         'Tuesday',
  'chips.anchor.wed':         'Wednesday',
  'chips.anchor.thu':         'Thursday',
  'chips.anchor.fri':         'Friday',
  'chips.anchor.sat':         'Saturday',
  'chips.anchor.sun':         'Sunday',
  'chips.time':               'Time',
...
const ZH: Dict = {
  ...
  /* Quick chips */
  'settings.chips':           '快捷时间',
  'chips.empty.relative':     '暂无相对时间，点击下方添加',
  'chips.empty.absolute':     '暂无绝对时间，点击下方添加',
  'chips.add':                '添加',
  'chips.add.title':          '新建快捷时间',
  'chips.edit.title':         '编辑快捷时间',
  'chips.delete':             '删除',
  'chips.reset':              '恢复默认',
  'chips.reset.confirm':      '恢复内置的快捷时间？自定义项会被移除。',
  'chips.label':              '名称',
  'chips.label.hint':         '如 午饭',
  'chips.amount':             '数值',
  'chips.unit':               '单位',
  'chips.unit.min':           '分钟',
  'chips.unit.hour':          '小时',
  ...
  'chips.unit.week.short':    'w',
  'chips.anchor':             '基准',
  'chips.anchor.today':       '今天',
  'chips.anchor.tomorrow':    '明天',
  'chips.anchor.mon':         '周一',
  'chips.anchor.tue':         '周二',
  'chips.anchor.wed':         '周三',
  'chips.anchor.thu':         '周四',
